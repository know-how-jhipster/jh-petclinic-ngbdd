...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.ujar.jh.petclinic.ngbdd.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.ujar.jh.petclinic.ngbdd.security.DomainUserDetailsService", "createSpringSecurityUser");
