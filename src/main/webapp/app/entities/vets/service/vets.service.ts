...
export class VetsService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/vets');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IVets[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
