...
export class SpecialtiesService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/specialties');
  ...
  search(req: Search): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ISpecialties[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
