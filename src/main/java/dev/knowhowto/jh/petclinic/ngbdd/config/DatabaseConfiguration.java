...
@Configuration
@EnableR2dbcRepositories({ "dev.knowhowto.jh.petclinic.ngbdd.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("dev.knowhowto.jh.petclinic.ngbdd.repository.search")
